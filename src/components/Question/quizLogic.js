    ...
    return (<div className="quiz-body">
        ...
        currentQues !== questionList.length-1 ?
              ...
              <Card elevation={12} sx={{ px: 'calc(2px + 1.5vw)', py: 'calc(2px + 1.5vw)' }} style={{display: 'inline-block' }}>
                    ...
                    <p>The correct answer is {anwers[0].answerText} </p>
                ...
                <Card elevation={12} sx={{ px: 'calc(2px + 1.5vw)', py: 'calc(2px + 1.5vw)' }} style={{display: 'inline-block' }}>
                  <CardContent>
                    ...
                    <br/>
                    <span>You have got {correctAnswers} correct answers.</span>
                  </CardContent>
                  <CardActions>{/* <Link to="/">Try anthoer quiz</Link> */}</CardActions>
                </Card>
        }
