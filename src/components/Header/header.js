      ...
      <div>
        ...
        <div className="explore">
          ...
          <p>
            ...
            way to explore the world and learn something new. So why not give
            them a try and see how much you really know about our amazing
            planet?
          </p>
        </div>
                ...
                <div className="card-back">
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      ...
                      anyone can become a geography whiz and ace their next
                      quiz! anyone can become a geography whiz and ace their
                      next quiz! anyone can become a geography whiz and ace
                      their next quiz!
                    </p>
                    <button
                      type="button"
                ...
                <div className="card-back">
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      ...
                      learning more about the world's natural wonders, a "which
                      is the tallest" quiz can be a great way to expand your
                ...
                <div className="card-back">
                  <div className="card-body ">
                    ...
                    <p className="card-text">
                      ...
                      can be a great way to improve your knowledge and have some
                      fun at the same time. way to improve your knowledge and
